									...
									<div class="row">
										<div class="col-md-5 pr-1">
											<div class="form-group">
													...
													ResultSet rs = st.executeQuery("select * from camp where cid='"+cid+"'");
													while (rs.next()) {
														String dist = rs.getString("dist");
														String add = rs.getString("address");
														String max = rs.getString("max");
														String cur = rs.getString("booking");
														String cname = rs.getString("cname");
													%>
										<b>District:	</b>		<%=dist%><br>
										
										<b>	Address:		</b><%=add%><br>
											<b>	Maximum Occupancy:	</b><%=max%><br>
										<b>Current Booking:	</b>		<%=cur%><br>
										<b>Total Members:		</b>	<input type="text" name="need" placeholder="Need">
											</div>
										</div>
