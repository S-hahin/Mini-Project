  ...
  <div class="wrapper">
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li >
            <a href="./createcamp.html">
              <i class="tim-icons icon-chart-pie-36"></i>
              <p>Create camp</p>
            </a>
          </li>
          <li>
            <a href="./viewcamp.html">
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="dropdown nav-item">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <div class="photo">
                    <img src="asets/img/anime3.png" alt="Profile Photo">
                  </div>
              ...
              <div class="card-body">
                <form>
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Cid</label>
                        <input type="text" class="form-control" placeholder="cid" value="">
                      </div>
                    </div>
                    <div class="col-md-4 pl-md-1">
                      <div class="form-group">
                        <label for="exampleInputEmail1">Cname</label>
                        <input type="taluk" class="form-control" placeholder="cname">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-6 pr-md-1">
                      <div class="form-group">
                        <label>Camp admin</label>
                        <input type="text" class="form-control" placeholder="admin" value="">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label>Things needed</label>
                        <input type="text" class="form-control" placeholder="needed" value="">
                      </div>
                    </div>
                  </div>
