...
<body class="">
<%String caname= session.getAttribute("caname").toString(); %>
  <div class="wrapper">
    <div class="sidebar">
      <!--
    ...
    -->
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          <li class="active ">
            <a href="createcamp.jsp?caname=<%=caname %>" target="ifr">
              <i class="tim-icons icon-chart-pie-36"></i>
              <p>Create camp</p>
            </a>
          </li>
          <li>
            <a href="viewcamp.jsp?caname=<%=caname %>" target="ifr">
          ...
          <li>
            <a href="viewreg.jsp?caname=<%=caname %>" target="ifr">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
          <div class="col-md-8">
            <iframe name="ifr" src="" id="ifr"></iframe>
          </div>
        </div>
      </div>
