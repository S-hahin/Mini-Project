...
<body>
	<div class="wrapper">
		<%
		String cname = session.getAttribute("caname").toString();
		String caname= null;
		String dist = null;
		String add = null;
		String loc = null;
					...
					<div class="col-md-12">
						<div class="card strpied-tabled-with-hover">
							<div class="card-header ">
								<h4 class="card-title">Registered Users are</h4>
...
<%
		...
		ResultSet rsc = stc.executeQuery("select * from user where cname='" + cname + "' and cname is not null");
		while (rsc.next()) {
		caname = rsc.getString("uname");
		dist = rsc.getString("district");
