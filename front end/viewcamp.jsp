					...
					<div class="col-md-12">
						<div class="card strpied-tabled-with-hover">
							<div class="card-header ">
								<h4 class="card-title">Your Camps Are</h4>
...
<%
		...
		ResultSet rsc = stc.executeQuery("select * from camp where caname='" + caname + "'");
		while (rsc.next()) {
			String cid = rsc.getString("cid");
		...
		%>
									<tr>
										...
										<td><%=dist %></td>
										<td><%=add %></td>
										<td><a href="<%=loc %>" target="_blank">Get Direction</a></td>
										<th><form action="delAction.jsp">
